...
public:
    ...
    [[nodiscard]] RprPpFilter get() const noexcept;
...
protected:
    ...
    [[nodiscard]] RprPpContext context() const noexcept { return m_context; }

    [[nodiscard]] RprPpFilter filter() const noexcept { return m_filter; }
