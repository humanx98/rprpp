...
public:
    ...
    [[nodiscard]]
    virtual const vk::raii::ImageView& view() const = 0;

    [[nodiscard]]
    virtual const vk::ImageLayout& layout() const = 0;

    [[nodiscard]]
    virtual const vk::PipelineStageFlags& stages() const = 0;

    [[nodiscard]]
    virtual const vk::AccessFlags& access() const = 0;

    [[nodiscard]]
    virtual const vk::Image& image() const = 0;
